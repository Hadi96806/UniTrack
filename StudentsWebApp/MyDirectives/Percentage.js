'use strict';
angular.module('myApp').directive('percentageDirective', ['$q',
    function ($q) {
        var directiveDefinitionObject = {
            ...
            templateUrl: 'MyDirectives/PercentageTemplate.html'
        ...
        function Ctor(ctrl, $scope, $attrs) {
            ...
            function defineApi() {
                ...
                api.load = function (paylaod) {
                    ...
                    function loadItemDirective() {
                        ...
                        directiveLoadDeferred.promise.then(function () {
                            var percentage = paylaod.PercentageValue;
                            console.log("Percentage: ", percentage);
                            if (percentage != undefined)
                                $scope.percentageValue = percentage;
                        });
                        // Return the promise
                ...
                api.getData = function () {
                    ...
                    // Return data
                    return {
                        $type: 'StudentsWebApp.Financial.Percentage, StudentsWebApp',
                        PercentageValue: $scope.percentageValue
                    };
                };
